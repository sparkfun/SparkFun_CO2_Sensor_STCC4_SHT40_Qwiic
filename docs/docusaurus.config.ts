...
const config: Config = {
    title: 'SparkFun CO2 Sensor - STCC4/SHT40 (Qwiic)',
    tagline: 'Monitor indoor environmental conditions including CO2 concentration, temperature and humidity with the SparkFun CO2 Sensor - STCC4/SHT40 (Qwiic).',
    ...
    baseUrl: '/SparkFun_CO2_Sensor_STCC4_SHT40_Qwiic',

    // GitHub pages deployment config.
    // If you aren't using GitHub pages, you don't need these.
    organizationName: 'sparkfun', // Usually your GitHub org/user name.
    projectName: 'SparkFun_CO2_Sensor_STCC4_SHT40_Qwiic', // Usually your repo name.
    ...
    themeConfig: {
        ...
        docsearch: {
            ...
            //------------------------------------------------------------------
            // // only search in the SparkFun CO2 Sensor STCC4/SHT40 (Qwiic) documentation - restrict on the section facet
            searchParameters: {
                facetFilters: ['section:SparkFun_CO2_Sensor_STCC4_SHT40_Qwiic'],
            },
        },

        navbar: {
            title: 'SparkFun CO2 Sensor - STCC4/SHT40 (Qwiic) Hookup Guide',
            logo: {
                alt: 'SparkFun Logo',
            ...
            items: [
                ...
                // },
                {
                    href: 'https://github.com/sparkfun/SparkFun_CO2_Sensor_STCC4_SHT40_Qwiic',
                    position: 'right',
            ...
            links: [
                {
                    ...
                    items: [
                        {
                            label: 'QwiicCO2SensorSTCC4SHT40',
                            href: 'https://www.sparkfun.com/sparkfun-co2-sensor-stcc4-sht40-qwiic.html'
                        },
                    ],
                },
                {
